...
describe("Tests exigés pour Space Invaders", function () {
  ...
  describe("Fonction lerp (Interpolation)", function () {
    ...
    it("doit retourner -107 quand on passe (1,10,-12)", function () {
  ...
  describe("Vecteurs et Géométrie", function () {
    ...
    it("toVector: convertit des coordonnées polaires en vecteur cartésien", function () {
      ...
      expect(result.y).toBeCloseTo(-47.946213733156924, 5);
    });

    it("normalize: normalise un vecteur", function () {
    ...
    it("dot: calcule le produit scalaire", function () {
    ...
    it("subtract: soustrait deux vecteurs {x, y}", function () {
